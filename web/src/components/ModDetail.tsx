...
import type { Loader, ProjectDetail, ProjectVersion } from '../types'
        ...
        {project && (
          <>
            <header className="detail-head">
              ...
              <div>
                ...
                <div className="detail-links">
                  <a href={`https://modrinth.com/mod/${project.slug}`} target="_blank" rel="noreferrer">
                    Modrinth page
                  </a>
                  {project.source_url && (
            ...
            <label className="deps-toggle">
              ...
              />
              Also download required dependencies
            </label>
